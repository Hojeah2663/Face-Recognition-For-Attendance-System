...
def take_img():
    try:
        ...
        Enrollment = txt.get()
        Name = txt2.get()
        path = 'C:\\Users\\apple\\Desktop\\Face Recognition For Attendance System\\Datasets\\' + Enrollment + ' ' + Name
        new_path = 'C:\\Users\\apple\\Desktop\\Face Recognition For Attendance System\\Datasets\\' + Enrollment + ' ' + Name + '/'
        os.mkdir(path)
        sampleNum = 0
...
message = tk.Label(window, text="Face-Recognition-For-Attendnace-System", bg="SpringGreen3", fg="white", width=50,
