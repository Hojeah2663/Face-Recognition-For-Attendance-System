    ...
    def log_in():
        ...
        if username == 'emma' :
            if password == 'emma2663':
                ...
                cs = 'C:\\Users\\apple\\Desktop\\Attendace_management_system\\StudentDetails\\StudentDetails.cvs'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Face-Recognition-For-Attendnace-System", bg="cyan", fg="black", width=50,
