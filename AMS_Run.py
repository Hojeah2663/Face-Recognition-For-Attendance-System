...
window = tk.Tk()
window.title("Face Recognition For Attendance System")
...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Button(ec, text='OK', command=ec_delete, fg="black", bg="violet", width=9, height=1, activebackground="Red",
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def err_screen1():
                ...
                Button(errsc2, text='OK', command=del_errsc2, fg="black", bg="violet", width=9, height=1,
            ...
            def create_csv():
                ...
                csv_name='C:\\Users\\apple\\Desktop\\Face Recognition For Attendance System\\Attendance\\Manually Attendance\\'+DB_table_name+'.csv'
                    ...
                    for col in reader:
                        ...
                        for row in col:
                            ...
                            label = tkinter.Label(root, width=13, height=1, fg="black", font=('times', 13, ' bold '),
                                                  bg="violet", text=row, relief=tkinter.RIDGE)
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\\Users\\apple\\Desktop\\Face Recognition For Attendance System\\Attendance\\Manually Attendance\\-------Check atttendance-------"')

            attf = tk.Button(MFW,  text="Check Sheets",command=attf,fg="black"  ,bg="violet"  ,width=12  ,height=1 ,activebackground = "Red" ,font=('times', 14, ' bold '))
...
def err_screen():
    ...
    Button(sc1,text='OK',command=del_sc1,fg="black"  ,bg="violet"  ,width=9  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold ')).place(x=90,y= 50)
...
def err_screen1():
    ...
    Button(sc2,text='OK',command=del_sc2,fg="black"  ,bg="violet"  ,width=9  ,height=1, activebackground = "Red" ,font=('times', 15, ' bold ')).place(x=90,y= 50)
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey')
                cs = 'C:\\Users\\apple\\Desktop\\Face Recognition For Attendance System\\' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\\Users\\apple\\Desktop\\Face Recognition For Attendance System\\Attendance\\-------Check atttendance-------"')

    attf = tk.Button(windo,  text="Check Sheets",command=Attf,fg="black"  ,bg="violet"  ,width=12  ,height=1 ,activebackground = "Red" ,font=('times', 14, ' bold '))
    ...
    def log_in():
        ...
        if username == 'emma' :
            if password == 'emma2663':
                ...
                cs = 'C:\\Users\\apple\\Desktop\\Face Recognition For Attendance System\\StudentDetails\\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Face-Recognition-For-Attendance-System", bg="cyan", fg="black", width=50,
...
trainImg = tk.Button(window, text="Train Images",fg="black",command=trainimg ,bg="violet"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
...
quitWindow = tk.Button(window, text="Manually Fill Attendance", command=manually_fill  ,fg="black"  ,bg="violet"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
